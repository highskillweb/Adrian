...
<head>
  ...
  <title>Adrian Caraman - Senior Front-end Developer</title>
            ...
            <div class="col-sm-12">
              <div class="home-inner">
                  <div class="center-align home-content">
                    <h1 class="home-title">HI! I'm <span>Adrian Caraman</span></h1>
                    <h2 class="home-subtitle">Front-End Developer from Chisinau, Moldova</h2>
          ...
          <div class="clearfix about-inner">
            ...
            <div class="col-sm-12 col-md-4">
              <div class="person-about">
                ...
                <a class="waves-effect waves-light btn-large brand-bg white-text" href="assets/adrian.pdf" target="_blank"><i class="mdi-content-archive left"></i> Download Resume</a>
              </div>
            </div>
            ...
            <div class="col-sm-6 col-md-4">
              <div class="person-info">
                ...
                <h5><span>Name :</span> Adrian Caraman</h5>
                <h5><span>Age :</span> 31 Years</h5>
                <h5><span>Email :</span> rapidly81@yandex.com</h5>
                <h5><span>Address :</span> Chisinau, Moldova</h5>
              </div>
                ...
                <div class="row">
                  <div class="clearfix section-head experience-text">
                    <div class="col-sm-12">
                      ...
                      <p class="regular-text">For 10 years, I have worked as a front end developer in Optimum-web Moldova, and have built and managed many websites.</p>
                    </div>
                  </div>
                  <div class="col-lg-12">
                      ...
                      <div class="row">
                        <div id="experienceSlider" class="clearfix card-element-wrapper">
                          <div class="col-sm-4 cold-xs-12 single-card-box wow fadeInUpSmall" data-wow-duration=".7s">
                            <div class="card">
                              <div class="card-image waves-effect waves-block waves-light">
                                <h2 class="left-align card-title-top">May 2007 - July 2011</h2>
                                <div class="valign-wrapper card-img-wrap">
                                  <img class="activator" src="./images/exp1.jpg" alt="">
                                </div>
                              </div>
                              <div class="card-content">
                                <span class="card-title activator brand-text">Junior Frontend Developer<i class="mdi-navigation-more-vert right"></i></span>
                                <p>Optimum-web</p>
                                <p>PHP, HTML, CSS</p>
                              </div>
                              <div class="card-reveal">
                                <div class="rev-title-wrap">
                                  <span class="card-title activator brand-text">Junior Frontend Developer<i class="mdi-navigation-close right"></i></span>
                                  <p>Optimum-web</p>
                                </div>
                                <p class="rev-content">
                          ...
                          <div class="col-sm-4 cold-xs-12 single-card-box wow fadeInUpSmall" data-wow-delay=".2s" data-wow-duration=".7s">
                            <div class="card">
                              <div class="card-image waves-effect waves-block waves-light">
                                <h2 class="left-align card-title-top">August 2011 - October 2014</h2>
                                <div class="valign-wrapper card-img-wrap">
                                  <img class="activator" src="./images/exp2.jpg" alt="">
                                </div>
                              </div>
                              <div class="card-content">
                                <span class="card-title activator brand-text">Senior Frontend Developer<i class="mdi-navigation-more-vert right"></i></span>
                                <p>Optimum-web</p>
                                <p>jQuery, HTML5, CSS3, Bootstrap</p>
                              </div>
                              <div class="card-reveal">
                                <div class="rev-title-wrap">
                                  <span class="card-title activator brand-text">Senior Frontend Developer<i class="mdi-navigation-close right"></i></span>
                                  <p>Optimum-web</p>
                                </div>
                                <p class="rev-content">
                                  - Worked closely with the product team to build new features for the desktop and mobile site. <br><br>
                                  - Had a lead role on the small team that produced Yelp's first UI style guide, and then made it available to the public. The style guide precipitated an organization-wide push towards modular design.<br><br>
                                  - Completely rebuilt Yelp's most important page--the business page--from scratch, using advanced CSS features for layout and interaction.<br><br>
                                  - Led the development of a complete overhaul of all email templates, including Yelp Weekly, which is sent to millions of users per week.<br><br>
                                  - Gained unique experience working on a large-scale software project with hundreds of contributors. Learned extensively about release engineering, including testing and deployment, as well as common web security vulnerabilities.<br>
                                </p>
                              </div>
                            </div>
                          </div>
                          <div class="col-sm-4 cold-xs-12 single-card-box wow fadeInUpSmall" data-wow-delay=".4s" data-wow-duration=".7s">
                            <div class="card">
                              <div class="card-image waves-effect waves-block waves-light">
                                <h2 class="left-align card-title-top">November 2014 - June 2016</h2>
                                <div class="valign-wrapper card-img-wrap">
                              ...
                              <div class="card-content">
                                <span class="card-title activator brand-text">Senior Frontend Developer<i class="mdi-navigation-more-vert right"></i></span>
                                <p>Optimum-web</p>
                                <p>AngularJS, React.js, D3.js, Highchart</p>
                              </div>
                              <div class="card-reveal">
                                <div class="rev-title-wrap">
                                  <span class="card-title activator brand-text">Senior Frontend Developer<i class="mdi-navigation-close right"></i></span>
                      ...
                      <div class="row">
                        ...
                        <!-- single education -->
                          <div class="col-sm-4 single-card-box wow fadeInUpSmall" data-wow-duration=".7s">
                            <div class="card">
                              <div class="card-image waves-effect waves-block waves-light">
                                <h2 class="left-align card-title-top">2000 - 2004</h2>
                          ...
                          <div class="col-sm-4 single-card-box wow fadeInUpSmall" data-wow-delay=".2s" data-wow-duration=".7s">
                            <div class="card">
                              <div class="card-image waves-effect waves-block waves-light">
                                <h2 class="left-align card-title-top">2004 - 2007</h2>
                                <div class="card-img-wrap">
                                  <img class="activator" src="./images/edu.jpg" alt="">
                                </div>
                              </div>
                          ...
                          <div class="card">
                            <div class="card-image waves-effect waves-block waves-light">
                              <div class="card-img-wrap">
                                ...
                                <p class="saying-about">Adrian was the only person who within the first meeting made me feel very confident and comfortable that he understood and could produce what we envisioned. It’s been a terrific experience working with him. I have never had to ask twice for answers and when delivered, he always made sense! The finished product is far superior than I imagined!</p>
                              </div>
                            </div>
                            <div class="card-content">
                          ...
                          <div class="card">
                            <div class="card-image waves-effect waves-block waves-light">
                              <div class="card-img-wrap">
                                ...
                                <p class="saying-about">I highly recommend Adrian as a web developer that is competent, talented and professional. He successfully took on my point of view of my project. His straightforward programming not only produced an exact replica, but created a more efficient, intuitive, and complete management system that has cut my admin time so dramatically I can now handle 5 clients in the time it previously took me to handle 1 client.</p>
                              </div>
                            </div>
                            <div class="card-content">
              ...
              <div class="row">
                <div class="clearfix section-head contact-text">
                  <div class="col-sm-12">
                    ...
                    <p class="regular-text">103 Mateevici street Chisinau Moldova</p>
                    <ul class="clearfix contact-info">
                      <li><a href="">Email: rapidly81@yandex.com</a>
                      </li>
                      <li><a href="">Skype: rapidly81</a>
                      </li>
                    </ul>
                  </div>
